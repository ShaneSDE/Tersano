...
exports.productRouter.delete('/slug/:slug', (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const product = yield productModel_1.ProductModel.findOneAndDelete({ slug: req.params.slug });
    if (product) {
